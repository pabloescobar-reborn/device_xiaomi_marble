...
echo 'Cloning Device Common Tree'
	git clone https://github.com/xiaomi-sm8450-marble/android_device_xiaomi_sm8450-common.git -b 15 device/xiaomi/sm8450-common
...
echo 'Cloning MemeCamera Tree'
	...
	git clone https://gitlab.com/pabloescobar-reborn/android_vendor_xiaomi_miuicamera-marble -b 15 vendor/xiaomi/miuicamera-marble

echo 'Cloning Hardware Dolby Tree'
	git clone https://github.com/xiaomi-sm8450-marble/android_hardware_dolby.git -b 15 hardware/dolby
...
echo 'Cloning Vendor Common Tree'
	git clone https://github.com/xiaomi-sm8450-marble/android_vendor_xiaomi_sm8450-common.git -b 15 vendor/xiaomi/sm8450-common
